...
const Speakers = () => (
  <div className="appears-content-with-mask overflow-scroll pointer-events-auto h-4/6 w-4/5 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg z-10">
    <div className="grid grid-cols-3 gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center font-mono text-white">
      {SPEAKERS.map(
        ({ name, image, presentationTopic, presentationDescription }) => {
          return (
            <div className=" w-4/5 max-h-[470px] rounded-lg p-6 backdrop-blur-sm bg-white/5 backdrop-brightness-150">
              <figure>
